...
while True:
	...
	if opcionMenu=="1":
		...
		print("Archivo de audio: EcosFinitos(800 ms).wav ")
		...
		print("Archivo de audio: EcosInfinitos(15 ms).wav")
		...
		print("Archivo de audio para cuerda: Cuerda.wav.wav")
		print("Archivo de audio para drum: Drum.wav")
