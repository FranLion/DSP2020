...
#Generar señales
señal,n,fs=senalTP() #Importar la señal sinusoidal definida en el Item 1.
...
sfd=mediamovild(señal,L-1) #Aplicar media movil directa
sfr=mediamovildr(señal,L-1) #Idem recursiva
...
f = np.arange(0,fs/2,(fs/2)/int(len(n)/2))
