...
dif1=int(round((desvioestandar1-1)*100))
dif2=int(round((desvioestandar2-1)*100))
dif3=int(round((desvioestandar3-1)*100))
dif4=int(round((desvioestandar4-1)*100))
dif5=int(round((desvioestandar5-1)*100))
dif6=int(round((desvioestandar6-1)*100))
